...
public class SpotifyController {
    ...
    public String createPlaylistOnName(@RequestParam(name = "mobile") String mobile, @RequestParam(name = "title") String title, @RequestBody List<String> songTitles) throws Exception{
